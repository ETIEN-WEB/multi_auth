        ...
        <div>
            <div style="margin-bottom:20px">
                ...
                <p>
                    ...
                    <span class="il">Dev Etien</span>.
                    Veuillez suivre ce lien pour créer un nouveau mot de passe:
                </p>
                <div>
                    <a href="{{route('annonceur.getResetPassword', $reset_code)}}" style="background-color:green;border:none;color:white;padding:10px 35px;
            ...
            <div>
                Cordialement,<br>
                L'équipe  <span class="il"><a href="https://meda.ci/">MEDA</a></span>
                Téléphone:  (+225) 07 876 021 32
            </div>
